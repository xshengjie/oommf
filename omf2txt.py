...
TCL_OOMMF=r'F:\oommf-tcl\tcl\bin\tclsh86t.exe F:\oommf-tcl\oommf12a5\oommf.tcl'
...
def zgs(addres,file):
    ...
    for i in os.listdir(addres):
        if os.path.splitext(i)[-1] in ['.omf','.oef'] and i!=file:#可以把'.omf'改成其他后缀来更改需要转格式的内容
